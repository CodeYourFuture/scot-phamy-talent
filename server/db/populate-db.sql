...
INSERT INTO applicant_profile
    (name, city, application_status, right_to_work, user_id)
VALUES
    ('Irina', 2, 'approved', FALSE, 2);

INSERT INTO company_profile
    (name, description, industry, user_id)
VALUES
    ('CYF', 'Tech company', 'Technology', 3);

INSERT INTO opportunities
    (name, description, contact_Person,telephone,email, city, date, company_id)
VALUES
    ('Volunteer with cyf', 'Two months in voluntary work', 'youssef', '0444445555', 'yan@cyf.com', 1, '2020-01-15', 1);
